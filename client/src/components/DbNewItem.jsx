    ...
    <div className='flex items-center justify-center flex-col pt-6 px-24 w-full'>
      <div className='border border-gray-300 rounded-md p-4 w-full flex flex-col items-center justify-center gap-4'>
        ...
        <motion.button
          ...
          {...buttonClick}
          className='w-9/12 py-2 rounded-md bg-blue-500 text-primary hover:bg-blue-600 cursor-pointer font-bold'
        >
          Save
        </motion.button>
      </div>
  ...
  return (
    <>
      <input
        ...
        className='w-full px-4 py-3 bg-cardOverlay shadow-md outline-none rounded-md border border-gray-200 focus:border-blue-400'
        value={stateValue}
